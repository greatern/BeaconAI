...
from app.models import user, report  # noqa: F401,E402

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Override the .ini's (blank) sqlalchemy.url with the one from our
# app settings, which reads DATABASE_URL from .env. Single source of truth.
